...
public class AkamaiAccountProtectorPlugin extends AbstractNodeAmPlugin {
    protected static final String CURRENT_VERSION = "0.0.17";
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return new ImmutableMap.Builder<String, Iterable<? extends Class<? extends Node>>>()
            .put("1.0.0", asList(AkamaiAccountProtectorNode.class))
            .build();
    }
    ...
    public String getPluginVersion() {
        return AkamaiAccountProtectorPlugin.CURRENT_VERSION;
    }
    ...
    public void upgrade(String fromVersion) throws PluginException {
        ...
        try {
            pluginTools.upgradeAuthNode(AkamaiAccountProtectorNode.class);
        }
        catch (Exception e) {
